...
The code we describe in this document has been used to create the dataset “A Multisource Grapevine Phenology Dataset for Smart Farming and AI Modeling”.  

Please, review https://github.com/fjlacueva/GrapevinePhenologyCode/blob/main/DIF_Readme.pdf for detailed information about the code.


#Readme “A Multisource Grapevine Phenology Dataset for Smart Farming and AI Modeling”.   

#Authors:
1.	Francisco José Lacueva-Pérez. Orcid: 0000-0003-0998-2939.  Affiliation: 1, 2
2.	Rafael del Hoyo-Alonso. Orcid: 0000-0003-2755-5500.  Affiliation: 1.
3.	Gorka Labata-Lezaun. Orcid: 0000-0002-8634-4124.  Affiliation: 1.
4.	Juan José Barriuso-Vargas. Orcid: 0000-0003-2980-5454.  Affiliation: 2.
5.	Sergio Ilarri-Artigas. Orcid: 0000-0002-7073-219X.  Affiliation: 2.
...
![Figure 1 Workflow implemented to transform data used to create ML models compared in [1].](WF1.png "Figure 1 Workflow implemented to transform data used to create ML models compared in [1].")
![Figure 2.  Subworkflow for creating the dataset presented in [2].](WF2.png "Figure 2.  Subworkflow for creating the dataset presented in [2].o")
...
Next module are involved in gathering data from the different data sources:
