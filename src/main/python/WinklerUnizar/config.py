...
paths2Libraries=['/projects/grapevine/GIT/src/src/main/python', '/projects/grapevine/GIT/src/src/main/python/Tools', '/projects/grapevine/GIT/src/src/main/python/HandlingDataFrames']
...
if not logger.handlers:
  loggingPath='{}/{}.log'.format(os.getenv('LOGSPATH', '/logs'), 'WinklerUnizar')
...
# variables_diarias_mean=['tmed_mean', 'rad_mean', 'hr_mean', 'wind_N', 'wind_NE', 'wind_E','wind_SE', 'wind_S', 'wind_SW', 
#                         'wind_W', 'wind_NW']
...
#path_to_models='/projects/grapevine/GIT/src/src/main/python/CreateModels/models/' ##Poner aquí la ruta de descompresión de la carpeta
