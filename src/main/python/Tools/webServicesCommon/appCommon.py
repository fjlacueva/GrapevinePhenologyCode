...
logger.info("Future jobs will be kept in memory for {} secs (see config.future_timeAliveSgs) after seen for first time".format(str(executor.future_timeAliveSgs)))
