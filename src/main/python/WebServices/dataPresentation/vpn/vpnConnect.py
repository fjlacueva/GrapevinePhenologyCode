...
def doCopy(src, dst):
    # sshpass -p "********" scp @src *******@ft2.cesga.es:/mnt/********
...
def executeEncryptedScript( encryptedFileWithCommand, privateKeyPath, *args):
    ...
    # regenerateCommand=False
    # if regenerateCommand:
    #     value=[b'sshpass -p "xxx" scp {} uuu@remoteServer:remoteFolder']        
    #     publicKeyPath='/projects/grapevine/GIT/src/src/main/python/WebServices/dataPresentation/certificates/vpn/private/privateVpn.pem'
