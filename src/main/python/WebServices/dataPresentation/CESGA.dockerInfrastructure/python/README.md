...
NOTE: This infrastructure contains the components to be exposed on the grapevine.itainnova.es host. The IT has to expose the 80 for the certificate management and 443 ports for the endpoints.
...
- **nginx**: for grapevine.itainnova.es endpoints configuration. A Basic user/password access policy is set with the following users
    + grapevine.
    ...
    >> https://grapevine.itainnova.es/vineyardsPhenologyPrediction
    ```
        {
    ...
    >**/diseasePrediction**
    >> https://grapevine.itainnova.es/vineyardsDiseasePrediction
    ```
        {
    ...
    >> https://grapevine.itainnova.es/jobs
    ...
    >> https://grapevine.itainnova.es/job/phenology-c3f6c888-5e52-11ec-9430-0242c0a8f002
    ```
            {
                createdTime: "Wed, 15 Dec 2021 10:36:25 GMT",
                done: false,
...
>> https://grapevine.itainnova.es/phenology?inputCsv=/data/phenology_vid_procesado.csv&outputCsv=/data/csv_salida.csv
```
        {
            createdTime: "Wed, 15 Dec 2021 10:36:25 GMT",
            done: false,
