        ...
        try:
            ...
            for station in stations:
                try:
                    ...
                    logger.debug("Datos de las variables recuperadas de las estación " + str(station))
                    ...
                    for key in keys:
                        try:
                            ...
                            logger.debug(str(code) + " recuperado")
                            ...
                            logger.warning("Error en la ejecución de la recuperación de información de las estaciones " + str(e))
                            logger.warning(str(e))

                except Exception as e:
                    logger.warning("Error en la ejecución de la recuperación de las estaciones " + str(e))
                    logger.warning(str(e))
            ...
            logger.error("Error en la ejecución de la recuperación de las estaciones " + str(e))
            logger.error(str(e))
            exit(-1)
    else:
