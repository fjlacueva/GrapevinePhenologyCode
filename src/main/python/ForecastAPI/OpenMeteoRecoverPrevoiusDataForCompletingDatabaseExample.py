...
def getForecast(logger,years,connection_db):
    ...
    if connection == 1:
        ...
        try:
            ...
            stations = [{"indicativo":'HU05',"long": 0.337850, "lat": 41.786430}]
                ...
                if stations[0]['indicativo'] != 'Z28':
                    ...
                    for year in years:
                        try:
                            ...
                            year = '2022-11-08'
                            query = 'SELECT "date", indicativo, samples  FROM public.gen_dateswithlesssamplesforstations where date = ' + "'" + str(
                                                        ...
                                                        if dataCount['contar'][0] == 0:
                                                            ...
                                                            try:
                                                                ...
                                                                data = {"id": index, "indicativo": indicativo, "ubi": None,
                                                                        ...
                                                                        "precip": precipitation, "vv": windspeed,
                                                                        "dv": int(winddirection), "humhoja": None,
                                                                        "presion": None, "rad": directradiation,
