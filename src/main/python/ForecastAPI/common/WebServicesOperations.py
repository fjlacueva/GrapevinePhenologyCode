...
def createUrlConcreteColumnsPreviousData(longitude,latitude,start_date,finish_date):

    url_all_data = 'https://archive-api.open-meteo.com/v1/era5?latitude=' + str(latitude) + '&longitude=' + str(
        longitude) + '&hourly=temperature_2m,relativehumidity_2m,dewpoint_2m,precipitation,direct_radiation,windspeed_10m,winddirection_10m'
    url_all_data = url_all_data + '&start_date=' + str(start_date) + '&end_date=' + str(finish_date)
    return url_all_data
